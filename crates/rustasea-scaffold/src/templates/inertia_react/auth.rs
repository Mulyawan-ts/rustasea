//! React (Dioxus) authentication page templates.
//!
...
pub fn mount(_props: &Value) -> Result<(), ClientError> {
    dioxus::launch(TwoFactorChallenge);
    Ok(())
}

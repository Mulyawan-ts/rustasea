...
The [canonical crate inventory](modules/manifest.md#canonical-crate-inventory-source-of-truth) lists **42 crates under `crates/` + `xtask` (43 workspace packages total)**; the module mappings below are a navigation aid.
